                  ...
                  child: Material(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text( "txtDeleteDesc".tr , maxLines: 2, textAlign: TextAlign.center, style: AppFontStyle.styleW500(Get.theme.primaryColor, AppFontSize.size_11)),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  addMedicineController.onTapOkDeleteBtn();
                                },
                                child: Container(
                                  width: AppSizes.fullWidth,
                                  padding: EdgeInsets.symmetric(vertical: AppSizes.height_1),
