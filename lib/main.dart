...
import 'package:pills_reminder/localization/localizations_delegate.dart';
import 'package:pills_reminder/routes/app_pages.dart';
import 'package:pills_reminder/routes/app_routes.dart';
import 'package:pills_reminder/themes/app_theme.dart';
...
void main() async {
  ...
  if (notificationAppLaunchDetails?.didNotificationLaunchApp ?? false) {
    isFullScreenNotification = notificationAppLaunchDetails?.didNotificationLaunchApp ?? false;
  ...
  final DarwinInitializationSettings initializationSettingsDarwin =
    ...
    onDidReceiveLocalNotification:
      ...
      print('onDidReceiveNotificationResponse: ${id}');
  ...
  await flutterLocalNotificationsPlugin.initialize(
    ...
    onDidReceiveNotificationResponse:
      ...
      print(
          'onDidReceiveNotificationResponse in Main: ${notificationResponse.id}');
      print(
          'onDidReceiveNotificationResponse in Main: ${notificationResponse.payload}');
    ...
    return Sizer(
      builder: (context, orientation, deviceType) {
        ...
        return GetMaterialApp(
          ...
          initialRoute: isUserLoggedIn ? AppRoutes.home : AppRoutes.signIn,
        );
      },
    );
  }
